...
ALTER TABLE AspNetUsers ADD Name VARCHAR(25)
ALTER TABLE AspNetUsers ADD PLastName VARCHAR(25)
ALTER TABLE AspNetUsers ADD MLastName VARCHAR(25)
ALTER TABLE AspNetUsers ADD BirthDate DATE
ALTER TABLE AspNetUsers ADD Street VARCHAR(25)
ALTER TABLE AspNetUsers ADD NoExt VARCHAR(10)
ALTER TABLE AspNetUsers ADD NoInt VARCHAR(10)
ALTER TABLE AspNetUsers ADD PostalCode VARCHAR(5)
ALTER TABLE AspNetUsers ADD CityId INT
ALTER TABLE AspNetUsers ADD DateAdded DATETIME DEFAULT GETDATE()
ALTER TABLE AspNetUsers ADD Blocked BIT DEFAULT 0